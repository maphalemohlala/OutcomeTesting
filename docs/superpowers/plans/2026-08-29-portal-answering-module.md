...
Scope values: Global `756150000`, Contact `756150001`, Account `756150002`, Parent `756150003`, Self `756150004`, Custom `756150005`. Web role ids are the two already used by the provisional permissions. **Corrected 2026-08-31 (AD-067): these are not the reviewer roles.** `c53b2908-1fc1-4470-89cd-6f5b95c17ffe` is the built-in **Administrators** role and `e24b50c5-1443-4725-84c9-70355724547f` is **Authenticated Users** (`authenticatedusersrole: true`), confirmed against DEV. Binding a permission to them grants it to every signed-in portal user, not to Tax and AQS Reviewers. The purpose-built `AL Portal - Tax Reviewer` (`a1000000-0000-4000-8000-000000000090`) and `AL Portal - AQS Reviewer` (`a1000000-0000-4000-8000-000000000091`) roles carry no table permissions at all.
