...
{
    /// <summary>
    /// A plug-in execution context with nothing in it but settable properties, for
    /// <see cref="FakeServiceProvider"/>. Every member of the interface is here because the
    /// interface requires it; only the few a test sets are meaningful.
    /// </summary>
