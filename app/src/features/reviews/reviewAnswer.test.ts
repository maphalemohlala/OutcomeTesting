 ...
 * typed answer read as unanswered on the Fail observation of the DEV Tax review.
 */
...
describe('answerOf', () => {
  ...
  it('reads the choice, not stray text, when a record holds both', () => {
    // The checklist has no free-text box beside a tick, so nothing writes this pair any
    // more; a record left from when it did still reads as the choice that was ticked.
